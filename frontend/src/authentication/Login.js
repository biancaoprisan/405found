...
class Login extends Component {
  ...
  authenticate = (event) => {
    ...
    axios
      .post('http://localhost:3003/api/authenticate', {email: this.state.inputEmail, password: this.state.inputPassword})
      .then(response => {
            ...
            <div className="col-sm-9 col-md-7 col-lg-5 mx-auto">
              <div className="card card-signin my-5">
                <div className="card-body">
                  <h5 className="card-title text-center">Aplicatie Note Proiecte</h5>
                  {errorMessage}
