...
class AddUser extends React.Component{
    ...
    addUser=(event)=>{
        ...
        if(this.state.email.includes("@")&&this.state.nume&&this.state.password)
        {axios.post('http://localhost:3003/api/user',user).then(res=>{
            console.log(res);
                  ...
                  <form className="form-signin">
                    <div className="form-label-group">
                      <input type="text" id="inputName" 
                             ...
                             placeholder="Name"
                             value = { this.state.nume } onChange={this.handleChangeName} 
                             required autoFocus />
